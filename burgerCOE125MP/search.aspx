<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="burgerCOE125MP.search" %>
...
<body class="homepage">
    <form runat="server">
        <div id="page-wrapper">
            ...
            <div id="header-wrapper">
                ...
                <section id="hero" class="container">
                    <header>
                        <h2><asp:Label runat="server" ID="lblSearch" Text="Search for "></asp:Label>
                        </h2>
                    </header>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:burgerDatabaseConnectionString %>" SelectCommand="SelectBurgerSearch" SelectCommandType="StoredProcedure">
            <SelectParameters>
